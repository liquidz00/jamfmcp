...
class SessionConfig(BaseModel):
    ...
    :param return_exceptions: Global setting that controls returning exceptions when
        :meth:`~jamfsdk.clients.JamfProClient.concurrent_operations` is invoked.  Setting this
...
class AccessToken(BaseModel):
    """
    Jamf Pro access token. Used by a :class:`~jamfsdk.clients.auth.CredentialsProvider`
