...
class ClassicAdvancedComputerSearchDisplayField(BaseModel):
    """
    lassicAdvancedComputerSearch nested model: advanced_computer_search.display_fields.
...
class ClassicAdvancedComputerSearchesItem(ClassicApiModel):
    ...
    :meth:`~jamfsdk.clients.classic_api.ClassicApi.list_all_advanced_computer_searches`
    operation.
    """
