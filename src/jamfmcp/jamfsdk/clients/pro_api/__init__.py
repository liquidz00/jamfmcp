...
class ProApi:
    ...
    async def get_computer_inventory_v1(
        ...
        :param sort_expression: (optional) The sort fields to apply to the request. See the
            ...
            .. autoapioptions:: jamfsdk.models.pro.api_options.get_computer_inventory_v1_allowed_sort_fields
        ...
        :param filter_expression: (optional) The filter expression to apply to the request. See the
            ...
            .. autoapioptions:: jamfsdk.models.pro.api_options.get_computer_inventory_v1_allowed_filter_fields
        ...
        return await paginator(return_generator=return_generator)
    ...
    async def get_packages_v1(
        ...
        :param sort_expression: (optional) The sort fields to apply to the request. See the
            ...
            .. autoapioptions:: jamfsdk.models.pro.api_options.get_packages_v1_allowed_sort_fields
        ...
        :param filter_expression: (optional) The filter expression to apply to the request. See the
            ...
            .. autoapioptions:: jamfsdk.models.pro.api_options.get_packages_v1_allowed_filter_fields
    ...
    async def get_jcds_files_v1(self) -> list[File]:
        ...
        return [File(**i) for i in response_json]

    async def create_jcds_file_v1(self) -> NewFile:
        """
        ...
        :rtype: NewFile
        """
        resp = await self.api_request(method="post", resource_path="v1/jcds/files")
        response_json = await resp.json()
        return NewFile(**response_json)

    async def get_jcds_file_v1(self, file_name: str) -> DownloadUrl:
        """
        ...
        :rtype: DownloadUrl
        """
        resp = await self.api_request(method="get", resource_path=f"v1/jcds/files/{file_name}")
        response_json = await resp.json()
        return DownloadUrl(**response_json)

    async def delete_jcds_file_v1(self, file_name: str) -> None:
        """
        ...
        .. warning::
            ...
            :meth:`~jamfsdk.clients.classic_api.ClassicApi.delete_package_by_id`.

        :param file_name: The name of the file to delete.
        :type file_name: str
        """
        await self.api_request(method="delete", resource_path=f"v1/jcds/files/{file_name}")
    ...
    async def renew_mdm_profile_v1(self, udids: list[str | UUID]) -> RenewMdmProfileResponse:
        ...
        try:
            return RenewMdmProfileResponse(
                udidsNotProcessed=response_json["udidsNotProcessed"]["udids"]
            )
        except KeyError:
    ...
    async def send_mdm_command_preview(
        ...
        .. code-block:: python
            ...
            from jamfsdk.models.pro.mdm import LogOutUserCommand
        ...
        resp = await self.api_request(
            method="post", resource_path="preview/mdm/commands", data=data
        )
        response_json = await resp.json()
        return [SendMdmCommandResponse(**i) for i in response_json]
    ...
    async def get_mdm_commands_v2(
        ...
        :param filter_expression: The filter expression to apply to the request. At least **one**
            ...
            .. autoapioptions:: jamfsdk.models.pro.api_options.get_mdm_commands_v2_allowed_filter_fields
        ...
        :param sort_expression: (optional) The sort fields to apply to the request. See the
            ...
            .. autoapioptions:: jamfsdk.models.pro.api_options.get_mdm_commands_v2_allowed_sort_fields
    ...
    async def get_mobile_device_inventory_v2(
        ...
        :param sort_expression: (optional) The sort fields to apply to the request. See the
            ...
            .. autoapioptions:: jamfsdk.models.pro.api_options.get_mobile_device_inventory_v2_allowed_sort_fields
        ...
        :param filter_expression: (optional) The filter expression to apply to the request. See the
            ...
            .. autoapioptions:: jamfsdk.models.pro.api_options.get_mobile_device_inventory_v2_allowed_filter_fields
